...
const ProfilePage: React.FC = () => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    if (name === "date") {
      ...
      if (value > today) return; // Prevent future date of birth
    }
  ...
  return (
    ...
    >
      ...
      <Box display="flex" flexDirection="column" alignItems="center" mb={4}>
        <Box position="relative">
          <Avatar src={profile.profilePicture} sx={{ width: 130, height: 130 }} />
          <IconButton
            sx={{
              position: "absolute",
              bottom: 0,
            ...
            size="small"
            onClick={() => alert("Profile picture update not implemented")}
          >
            <EditIcon fontSize="small" />
          </IconButton>
        </Box>
